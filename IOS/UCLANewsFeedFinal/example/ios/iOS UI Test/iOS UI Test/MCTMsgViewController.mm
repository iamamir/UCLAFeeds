...
//    UIImageView *imageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"headerMailBox"]];
//    [imageView setFrame:CGRectMake(0, 0, 375, 60)];
//    [self.view addSubview:imageView];
//    
//    UIButton *popViewButton = [[UIButton alloc] initWithFrame:CGRectMake(15, 20, 12, 21)];
//    [popViewButton setImage:[UIImage imageNamed:@"leftArrow"] forState:UIControlStateNormal];
//    [popViewButton addTarget:self action:@selector(popView) forControlEvents:UIControlEventTouchUpInside];
//    [self.view addSubview:popViewButton];
//    
//    UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake(self.view.frame.size.width / 2, 20, 100, 40)];
//    [label setText:@"Detail Page"];
//    [label setTextColor:[UIColor whiteColor]];
//    [self.view addSubview:label];

    
    _messageView = [[MCOMessageView alloc] initWithFrame:CGRectMake(0, 60, self.view.frame.size.width, self.view.frame.size.height)];
